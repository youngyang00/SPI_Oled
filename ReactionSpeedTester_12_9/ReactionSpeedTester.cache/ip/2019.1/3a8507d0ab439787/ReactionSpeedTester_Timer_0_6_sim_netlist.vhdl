...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_timer is
  port (
    ...
    \counter_reg[31]_0\ : in STD_LOGIC_VECTOR ( 1 downto 0 );
    s00_axi_aclk : in STD_LOGIC
  );
...
\counter_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => \counter_reg[31]_0\(0),
      D => p_2_in(0),
      Q => \^q\(0),
      R => \counter_reg[31]_0\(1)
    );
...
timer_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_timer
     port map (
      ...
      \counter_reg[31]_0\(1 downto 0) => slv_reg1(1 downto 0),
      s00_axi_aclk => s00_axi_aclk
    );
end STRUCTURE;
library IEEE;
