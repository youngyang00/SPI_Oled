...
HD_PWD='D:/backup/ReactionSpeedTester_12_9/ReactionSpeedTester.runs/ReactionSpeedTester_Timer_0_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ReactionSpeedTester_Timer_0_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ReactionSpeedTester_Timer_0_6.tcl
