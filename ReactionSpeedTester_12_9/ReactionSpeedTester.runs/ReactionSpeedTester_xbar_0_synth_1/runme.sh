...
HD_PWD='D:/backup/ReactionSpeedTester_12_9/ReactionSpeedTester.runs/ReactionSpeedTester_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ReactionSpeedTester_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ReactionSpeedTester_xbar_0.tcl
