...
HD_PWD='D:/backup/ReactionSpeedTester_12_9/ReactionSpeedTester.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ReactionSpeedTester_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ReactionSpeedTester_wrapper.tcl -notrace
