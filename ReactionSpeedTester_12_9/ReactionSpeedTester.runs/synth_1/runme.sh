...
HD_PWD='D:/backup/ReactionSpeedTester_12_9/ReactionSpeedTester.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ReactionSpeedTester_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ReactionSpeedTester_wrapper.tcl
