...
HD_PWD='k:/gwang/ip_repo/oledcontrol/edit_oledControl_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log oledControl_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source oledControl_v1_0.tcl
