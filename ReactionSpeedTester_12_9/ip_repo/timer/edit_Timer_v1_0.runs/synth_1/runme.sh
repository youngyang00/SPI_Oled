...
HD_PWD='D:/backup/ReactionSpeedTester_12_9/ip_repo/timer/edit_Timer_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Timer_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Timer_v1_0.tcl
